  ...
  mejs.MediaElementPlayer.prototype = {
    ...
    setPlayerSize: function (width, height) {
      ...
      if (
        ...
        parseInt(t.$node.css('max-width').replace(/px/, ''), 10) /
          t.$node.offsetParent().width() ===
          1 ||
        (t.$node[0].currentStyle && t.$node[0].currentStyle.maxWidth === '100%')
      ) {
        // do we have the native dimensions yet?
        var nativeWidth = t.isVideo
      ...
      playButton.css(
        'margin-top',
        '-' +
          (playButton.height() / 2 - t.controls.height() / 2).toString() +
          'px'
      );
    },
  ...
  $.extend(MediaElementPlayer.prototype, {
    ...
    buildfullscreen: function (player, controls, layers, media) {
      ...
      if (
        ...
        (!t.options.usePluginFullScreen && !mejs.MediaFeatures.isFirefox)
      ) {
